...
print()
print("==========================================================")
print("Research Factor:", FACTOR_NAME)
print("==========================================================")
print()
...
#==========================================================
research_df.to_csv(
  f"{FACTOR_NAME.lower()}_research.csv",
  index=False
  )
print()
print("Saved:")
...
rank_15m.to_csv(
    f"{FACTOR_NAME.lower()}_rank_15m.csv"
)
#==========================================================
...
rank_30m.to_csv(
    f"{FACTOR_NAME.lower()}_rank_30m.csv"
)
#==========================================================
...
rank_60m.to_csv(
    f"{FACTOR_NAME.lower()}_rank_60m.csv"
)